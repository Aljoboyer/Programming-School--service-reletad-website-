...
const Login = () => {
    ...
    const {setIsloading,setUser,LoginWithGithub,LoginWithGoogle,LoginWithEmailAndPass,user} = useAuth();
    ...
    const onSubmit = data => {
        ...
        const GithubSignin = () => {
            ...
            .then((result) => {
                ...
                console.log('from github', error.message)
              }).finally(() => setIsloading(false))
        }
    return (
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <p><i className="mt-3 mb-2 text-center far fa-circle fa-2x">R</i></p>
                    ...
                    <i onClick={GoogleSignin}  className="ms-2 mb-2 fab fa-google fa-3x"></i>
                       <i onClick={GithubSignin} className="ms-2 fab fa-github fa-3x"></i>
